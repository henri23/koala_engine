...
b8 vulkan_fence_wait(
    ...
    if (!fence->is_signaled) {
        ...
        case VK_SUCCESS:
            ...
            return TRUE;
        case VK_TIMEOUT:
            ENGINE_WARN("vk_fence_wait - Timed out");
            break;
        case VK_ERROR_DEVICE_LOST:
            ENGINE_ERROR("vk_fence_wait - VK_ERROR_DEVICE_LOST");
            break;
        case VK_ERROR_OUT_OF_HOST_MEMORY:
            ENGINE_ERROR("vk_fence_wait - VK_ERROR_OUT_OF_HOST_MEMORY");
            break;
        case VK_ERROR_OUT_OF_DEVICE_MEMORY:
            ENGINE_ERROR("vk_fence_wait - VK_ERROR_OUT_OF_DEVICE_MEMORY");
            break;
        default:
