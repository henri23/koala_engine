...
// Math functions
KOALA_API f32 math_sin(f32 x);
KOALA_API f32 math_cos(f32 x);
KOALA_API f32 math_tan(f32 x);
KOALA_API f32 math_arccos(f32 x);
KOALA_API f32 math_sqrt(f32 x);
KOALA_API f32 math_abs_value(f32 x);

KOALA_INLINE b8 math_is_power_of_2(u64 value) {
    return (value != 0) && ((value & (value - 1)) == 0);
};

KOALA_API s32 math_random_signed();
KOALA_API f32 math_random_float();

KOALA_API s32 math_random_signed_in_range(s32 min, s32 max);
KOALA_API f32 math_random_float_in_range(f32 min, f32 max);

// Vector 2 functions and operators
KOALA_INLINE vec2 vec2_create(float x, float y) {
    vec2 result = {x, y};
    return result;
}
...
KOALA_INLINE f32 vec2_length_squared(vec2 a) {
    return a.x * a.x + a.y * a.y;
}

KOALA_INLINE f32 vec2_length(vec2 a) {
    return math_sqrt(vec2_length_squared(a));
}

KOALA_INLINE void vec2_norm(vec2* a) {
    const f32 length = vec2_length(*a);
    a->x /= length;
    a->y /= length;
}

KOALA_INLINE vec2 vec2_norm_copy(vec2 a) {
    vec2_norm(&a);
...
KOALA_INLINE vec3 vec3_create(float x, float y, float z) {
    vec3 result = {x, y, z};
    return result;
}
...
KOALA_INLINE f32 vec3_length(vec3 a) {
...
KOALA_INLINE vec3 vec3_norm_copy(vec3 a) {
    vec3_norm(&a);
    return a; // Returns a copy
}
...
KOALA_INLINE vec4 vec4_create(f32 x, f32 y, f32 z, f32 w) {
    vec4 out_vector;
    out_vector.x = x;
    out_vector.y = y;
    out_vector.z = z;
...
KOALA_INLINE f32 vec4_length(vec4 a) {
    return math_sqrt(vec4_length_squared(a));
}

KOALA_INLINE void vec4_norm(vec4* a) {
...
KOALA_INLINE vec4 vec4_norm_copy(vec4 a) {
    vec4_norm(&a);
    return a; // Returns a copy
}

KOALA_INLINE f32 vec4_dot_f32(
    f32 ax, f32 ay, f32 az, f32 aw,
    f32 bx, f32 by, f32 bz, f32 bw) {
    return ax * bx + ay * by + az * bz + aw * bw;
}

KOALA_INLINE mat4 mat4_identity() {
    mat4 out_matrix;
...
KOALA_INLINE mat4 operator*(mat4 m1, mat4 m2) {
...
// the camera.
KOALA_INLINE mat4 mat4_project_orthographic(
    f32 left,
    f32 right,
    f32 bottom,
    f32 top,
...
KOALA_INLINE mat4 mat4_project_perspective(
    f32 fov_radians,
    f32 aspect_ratio,
    f32 near_clip,
    f32 far_clip) {
...
KOALA_INLINE mat4 mat4_look_at(
    vec3 position,
    vec3 target,
    vec3 up) {
    mat4 out_matrix;
...
KOALA_INLINE mat4 mat4_transpose(mat4 matrix) {
...
KOALA_INLINE mat4 mat4_inv(mat4 matrix) {
...
KOALA_INLINE mat4 mat4_translation(vec3 position) {
    mat4 out_matrix = mat4_identity();
...
KOALA_INLINE mat4 mat4_scale(vec3 scale) {
    mat4 out_matrix = mat4_identity();
...
KOALA_INLINE mat4 mat4_euler_x(f32 yaw_radians) {
    mat4 out_matrix = mat4_identity();
...
KOALA_INLINE mat4 mat4_euler_y(f32 pitch_radians) {
    mat4 out_matrix = mat4_identity();
...
KOALA_INLINE mat4 mat4_euler_z(f32 roll_radians) {
    mat4 out_matrix = mat4_identity();
...
KOALA_INLINE mat4 mat4_euler_xyz(
    f32 yaw_radians,
    f32 pitch_radians,
    f32 roll_radians) {
...
KOALA_INLINE vec3 mat4_forward(mat4 matrix) {
    vec3 forward;
...
KOALA_INLINE vec3 mat4_backward(mat4 matrix) {
    vec3 backward;
...
KOALA_INLINE vec3 mat4_up(mat4 matrix) {
    vec3 up;
...
KOALA_INLINE vec3 mat4_down(mat4 matrix) {
    vec3 down;
...
KOALA_INLINE vec3 mat4_left(mat4 matrix) {
    vec3 left;
...
KOALA_INLINE vec3 mat4_right(mat4 matrix) {
    vec3 right;
...
KOALA_INLINE quaternion quat_mul(quaternion q0, quaternion q1) {
...
KOALA_INLINE f32 quat_dot(quaternion q0, quaternion q1) {
...
KOALA_INLINE mat4 quat_to_mat4(quaternion q) {
...
KOALA_INLINE mat4 quat_to_rotation_matrix(quaternion q, vec3 center) {
...
KOALA_INLINE quaternion quat_from_axis_angle(
    vec3 axis,
    f32 angle,
    b8 normalize) {
...
KOALA_INLINE quaternion quat_slerp(
    quaternion q0,
    quaternion q1,
    f32 percentage) {
...
KOALA_INLINE f32 rad_to_deg(f32 radians) {
